...
type hostedAgentModel struct {
	...
	ProtocolVersions     []protocolVersionModel `tfsdk:"container_protocol_versions"`
}
...
type hostedAgentDefinition struct {
	...
	ProtocolVersions     []protocolVersion `json:"container_protocol_versions"`
}
...
func (r *hostedAgentResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	...
	attributes["container_protocol_versions"] = schema.ListNestedAttribute{
		Required:            true,
